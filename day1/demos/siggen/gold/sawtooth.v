module Adc32_1 (input [31:0] I0, input [31:0] I1, output [31:0] O, output  COUT);
wire  inst0_O;
wire  inst1_CO;
wire  inst2_O;
wire  inst3_CO;
...
SB_LUT4 #(.LUT_INIT(16'hC33C)) inst60 (.I0(1'b0), .I1(I0[30]), .I2(I1[30]), .I3(inst59_CO), .O(inst60_O));
SB_CARRY inst61 (.I0(I0[30]), .I1(I1[30]), .CI(inst59_CO), .CO(inst61_CO));
SB_LUT4 #(.LUT_INIT(16'hC33C)) inst62 (.I0(1'b0), .I1(I0[31]), .I2(I1[31]), .I3(inst61_CO), .O(inst62_O));
SB_CARRY inst63 (.I0(I0[31]), .I1(I1[31]), .CI(inst61_CO), .CO(inst63_CO));
...
wire  inst0_COUT;
wire [31:0] inst1_O;
Adc32_1 inst0 (.I0(inst1_O), .I1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1}), .O(inst0_O), .COUT(inst0_COUT));
Register32 inst1 (.I(inst0_O), .O(inst1_O), .CLK(CLK));
assign O = inst1_O;
assign COUT = inst0_COUT;
endmodule

module main (output [7:0] SIG, input  CLKIN);
wire [31:0] inst0_O;
wire  inst0_COUT;
Counter32 inst0 (.O(inst0_O), .COUT(inst0_COUT), .CLK(CLKIN));
assign SIG = {inst0_O[15],inst0_O[14],inst0_O[13],inst0_O[12],inst0_O[11],inst0_O[10],inst0_O[9],inst0_O[8]};
endmodule
