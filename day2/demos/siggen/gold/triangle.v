...
module Triangle8 (input [7:0] I, output [7:0] O);
wire [7:0] inst0_O;
wire [7:0] inst1_O;
Invert8 inst0 (.I(I), .O(inst0_O));
Mux2x8 inst1 (.I0(I), .I1(inst0_O), .S(I[7]), .O(inst1_O));
assign O = inst1_O;
endmodule
...
Triangle8 inst1 (.I({inst0_O[15],inst0_O[14],inst0_O[13],inst0_O[12],inst0_O[11],inst0_O[10],inst0_O[9],inst0_O[8]}), .O(inst1_O));
assign J3 = inst1_O;
endmodule
